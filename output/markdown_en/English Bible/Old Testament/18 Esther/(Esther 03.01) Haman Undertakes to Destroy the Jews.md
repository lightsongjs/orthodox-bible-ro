...
chapter: 3
pericope: 1
pericope_title: "Haman Undertakes to Destroy the Jews"
verses_start: 2
verses_end: 13
verses_total: 0
language: en
...
7. In the first month, which is the month of Nisan, in the twelfth year of King Ahasuerus, they cast Pur—which means “the lot”—before Haman for the day and for the month, and the lot fell on the thirteenth dayof the twelfth month, which is the month of Adar.
